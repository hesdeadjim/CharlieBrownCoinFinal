CharlieBrownCoin-qt: Qt4 GUI for CharlieBrownCoin
===============================
...
Alternatively, install Qt Creator and open the `CharlieBrownCoin-qt.pro` file.

An executable named `CharlieBrownCoin-qt` will be built.
...
A warning for people using the *static binary* version of CharlieBrownCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of CharlieBrownCoin is linked against libdb5.3.
...
installed causes CharlieBrownCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
