...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CharlieBrownCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-start");
