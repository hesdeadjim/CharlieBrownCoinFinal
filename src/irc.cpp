...
void ThreadIRCSeed(void* parg)
{
    ...
    RenameThread("CharlieBrownCoin-ircseed");
...
void ThreadIRCSeed2(void* parg)
{
    ...
    while (!fShutdown)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #CharlieBrownCoinTEST2\r");
            Send(hSocket, "WHO #CharlieBrownCoinTEST2\r");
        } else {
            // randomly join #CharlieBrownCoin00-#CharlieBrownCoin05
            // int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #CharlieBrownCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #CharlieBrownCoin%02d\r", channel_number).c_str());
        }
