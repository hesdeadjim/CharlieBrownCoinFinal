...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CBC");
    case mBTC: return QString("mCBC");
    case uBTC: return QString::fromUtf8("μCBC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("CharlieBrownCoins"));
    case mBTC: return QString(QObject::tr("Milli-CharlieBrownCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-CharlieBrownCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
