...
unsigned int nStakeTargetSpacing = 500; // minute stakes spacing
int64_t nTargetSpacing = 500;  // Same as the above
...
const string strMessageMagic = "CharlieBrownCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 500 * 15;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("CharlieBrownCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CharlieBrownCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // CharlieBrownCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CharlieBrownCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "charliebrowncoin Genesis";
        CTransaction txNew;
        ...
        block.nNonce   = 20441; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xa4, 0xa8, 0xe2, 0xe5 };
